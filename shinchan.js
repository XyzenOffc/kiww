...
conn.ev.on("connection.update",async  (s) => {
        ...
        if (connection == "open") {
			...
			await delay(1999)
            console.log(chalk.yellow(`\n\n                  ${chalk.bold.blue(`[ 𝖀𝖑𝖙𝖗𝖆V2.5 𝘽𝙊𝙏 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 ]`)}\n\n`))
            console.log(chalk.cyan(`< ================================================== >`))
            console.log(chalk.magenta(`\n🐼 𝙂𝙄𝙏𝙃𝙐𝘽: KEBAN `))
            console.log(chalk.magenta(`🐼 𝙄𝙉𝙎𝙏𝘼𝙂𝙍𝘼𝙈: @user108995561 `))
            console.log(chalk.magenta(`🐼 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋: 60166648304`))
            console.log(chalk.magenta(`🐼 @hwuwhw99\n`))
        }
        if (
            connection === "close" &&
            lastDisconnect &&
